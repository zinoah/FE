...
document.getElementById("btn1").addEventListener("click", function () {
  // 부모
  // 요소.parentNode : 요소의 부모 노드를 탐색하서 반환
  ...
  // 형제
  // 요소.previousSibling : 요소의 이전 현제 노드를 반환
  // 요소.nextSibling : 요소의 다음 현제 노드를 반환
...
document.getElementById("btn2").addEventListener("click", function () {
  ...
  console.log(list); // HTMLCollection 형태로 변환
